                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">All HTML headings, <code
                                            className="highlighter-rouge">&lt;h1&gt;</code> through <code
                                                className="highlighter-rouge">&lt;h6&gt;</code>, are available.
                                        </CardSubtitle>
                                        ...
                                        <h6 className="mb-0">h6. Bootstrap heading <small className="text-muted">Semibold 1rem (16px)</small></h6>
                                    </CardBody>
                                </Card>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Styling for common inline HTML5 elements.</CardSubtitle>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Remove the default <code
                                            ...
                                            for any nested lists as well.</CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Traditional heading elements are designed to work best in the meat of your page content. </CardSubtitle>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">For quoting blocks of content from
                                            another source within your document. Wrap <code
                                                ...
                                                title="HyperText Markup Language">HTML</abbr> as the quote.</CardSubtitle>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Remove a list’s bullets and apply some
                                            ...
                                            <code className="highlighter-rouge">.list-inline-item</code>.</CardSubtitle>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">
                                            Align terms and descriptions horizontally by using our grid system’s predefined classNamees (or semantic mixins). For longer terms, you can optionally add a <code className="highlighter-rouge">.text-truncate</code> className to truncate the text with an ellipsis.
                                        </CardSubtitle>
